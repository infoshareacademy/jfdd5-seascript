...
function moveObstacles() {
  for (var j = 0; j < obstaclesCollection.length; j++) {
    var previousPos = $('#game-cell_' + obstaclesCollection[j].rowPos + '_' + obstaclesCollection[j].colPos); //czy da się to jakoś ulepszyć, przypisanie do zmiennej
...
function updateGame() {
  ...
  setInterval(controlSurfer, 200); //jak zatrzymać surfera?XD
}
