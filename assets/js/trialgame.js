...
function moveKiter() {
    $(window).on('key down', function move(event) {
        var kiter = $('#game-cell_14_3').addClass('kiter');
        if (keyCode === controls.LEFT_ARROW) {
            kiter = directions.LEFT;
        } else if (event.keyCode === controls.UP_ARROW) {
            kiter = directions.UP;
        } else if (event.keyCode === controls.RIGHT_ARROW) {
            kiter = directions.RIGHT;
        } else if (event.keyCode === controls.DOWN_ARROW) {
            kiter = directions.DOWN;
        }
    });
}


// $(window).keydown(function moveKiter(e) {
//   var kiter_direction =
//   if (e.keyCode === controls.LEFT_ARROW) {
//     kiter_direction = directions.LEFT;
//   } else if (e.keyCode === controls.UP_ARROW) {
//     kiter_direction = directions.UP;
//   } else if (e.keyCode === controls.RIGHT_ARROW) {
//     kiter_direction = directions.RIGHT;
//   } else if (e.keyCode === controls.DOWN_ARROW) {
//     kiter_direction = directions.DOWN;
//   }
// });
